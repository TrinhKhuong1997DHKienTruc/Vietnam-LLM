...
parser.add_argument('--no_plot', action="store_true", dest="no_plot", help='Disable plotting display')
...
while portfolio_return == 0: # a hack to avoid stationary case
    ...
    for t in range(1, trading_period + 1):
        if model_name == 'DDPG':
            ...
            actions = agent.model.predict(agent._prepare_state(state))[0]
