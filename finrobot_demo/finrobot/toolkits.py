try:
	from autogen import register_function, ConversableAgent  # type: ignore
except Exception:
	from finrobot.autogen_compat import register_function  # type: ignore
	from autogen_agentchat.agents import AssistantAgent as ConversableAgent  # type: ignore
