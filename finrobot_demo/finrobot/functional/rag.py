try:
	...
	# Fallback: not supported in autogen_core >=0.7; provide a no-op stub
	class RetrieveUserProxyAgent:
		def __init__(self, *args, **kwargs):
			pass
		def reset(self):
			pass
		def _check_update_context(self, *args, **kwargs):
			return False, False
		def _generate_retrieve_user_reply(self, *args, **kwargs):
			return None, ""
