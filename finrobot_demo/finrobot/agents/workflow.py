...
try:
	...
	from finrobot.autogen_compat import *  # type: ignore
	import finrobot.autogen_compat as autogen  # type: ignore
try:
	from autogen.cache import Cache  # type: ignore
except Exception:
	from finrobot.autogen_compat import Cache  # type: ignore
try:
	from autogen import (
		ConversableAgent,
		AssistantAgent,
	...
	from finrobot.autogen_compat import (
		AssistantAgent,
		UserProxyAgent,
		GroupChat,
		GroupChatManager,
	...
	ConversableAgent = AssistantAgent  # fallback
